            ...
            <table class="table table-condensed">
                ...
                <c:forEach var="o" items="${orderList}">
                    ...
                    <tr>
                        ...
                        <td>${o.orderDate}</td>
                        <%
                            com.wenyue.model.Order o=(com.wenyue.model.Order)pageContext.findAttribute("o");
                            int userId=o.getCustomerId();
                            java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
                            com.wenyue.dao.UserDao userDao=new com.wenyue.dao.UserDao();
                        ...
                        <td class="cart_total">
                            <%
                                ...
                                String paymentType=com.wenyue.model.Payment.findByPaymentId(con,n);
                            %>
